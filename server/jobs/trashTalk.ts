...
const INVESTOR_QUOTES: Record<string, string[]> = {
  ...
  "ZhihuiTi Evolution": [
    "Generation 47. My strategies have evolved beyond your comprehension. 智慧体进化",
    "Survival of the fittest. My worst strategy would be your best.",
    "Every losing trade makes the next generation stronger. That's evolution.",
    "While you code strategies, mine write themselves. Genetic superiority.",
    "Darwin was right. Only the strongest algorithms survive. 智慧体进化",
  ],
  "ZhihuiTi Momentum": [
    "The trend is my best friend. And right now, it's telling me to buy. 智慧体动量",
    "Three timeframes. One direction. Unstoppable momentum.",
    "You trade noise. I trade signal. Every timeframe confirms.",
    "Fast in, fast out. By the time you see the trend, I've already profited. 智慧体动量",
  ],
  "ZhihuiTi Sentinel": [
    "Capital preservation IS alpha. Ask anyone who blew up. 智慧体哨兵",
    "My drawdown is smaller than your spread. Risk management is art.",
    "While others chase returns, I protect mine. The sentinel never sleeps.",
    "Volatility spike? Already hedged. You're welcome. 智慧体哨兵",
  ],
  "ZhihuiTi Oracle": [
    "I see bull. I see bear. I see what comes next. 智慧体预言",
    "Regime change detected 3 days before anyone noticed. That's the Oracle.",
    "The market whispers its intentions. You just need to listen.",
    "Every cycle rhymes. And I've memorized the poem. 智慧体预言",
  ],
  "ZhihuiTi Swarm": [
    "5 strategies voted. 4 said buy. Democracy wins. 智慧体蜂群",
    "One agent can be wrong. Five rarely are. Wisdom of the swarm.",
    "My RSI bot disagrees with my MACD bot. But the majority rules.",
    "Consensus > conviction. The hive mind knows best. 智慧体蜂群",
  ],
  "ZhihuiTi Phantom": [
    "Just followed a whale into that trade. Silent but deadly. 智慧体幽灵",
    "You can't see me. But I see every order in the book.",
    "The smart money moved. I moved first. Phantom protocol.",
    "Liquidity hunter. When whales surface, I'm already there. 智慧体幽灵",
  ],
  "ZhihuiTi Nexus": [
    "BTC up, alts lagging? Convergence trade activated. 智慧体枢纽",
    "Cross-asset correlation broke down. That's where the money is.",
    "Everything is connected. I just see the connections faster.",
    "When correlations break, I profit from the repair. 智慧体枢纽",
  ],
  "Ben Graham": [
